...
public class JDBCAdapter {
  ...
  public JDBCAdapter() {
    ...
    JDBCAdapter(String url, String driverName, String user, String passwd) {
      ...
      while (resultSet.next()) {
        ...
        for (int i = 1; i <= getColumnCount(); i++) {
          ...
          try {
            ...
            Logger.getLogger(JDBCAdapter.class.getName()).log(Level.SEVERE, "Error ejecutando el Query", e);   
            type = Types.VARCHAR;
          }
    ...
    try {
      ...
      if (statement != null) {
        try {
          ...
          Logger.getLogger(JDBCAdapter.class.getName()).log(Level.SEVERE, "Error", e);   
        }
      }
      if (connection != null) {
        try {
  ...
  public void setValueAt(Object value, int row, int column) {
    try {
      ...
      Logger.getLogger(JDBCAdapter.class.getName()).log(Level.SEVERE, null, e);      
    }
