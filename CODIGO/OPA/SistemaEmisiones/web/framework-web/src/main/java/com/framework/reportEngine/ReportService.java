    ...
    public class ReportService {
      ...
      public QueryContainer creaConsultaWeb20(UI app ) {
        ...
        return c.creaConsulta(app, getConfigCampos(), tituloCompleto, query, args);
      }

      public QueryContainer creaConsultaWeb20(UI app, List<Map<String, Object>> data) {
        ConsultaWeb20 c = new ConsultaWeb20();
        String tituloCompleto = getSubtitulo().length() > 0 ? getTitulo().trim() + " - " + getSubtitulo().trim() : getTitulo().trim();
        c.setFieldDelimiter(fieldDelimiter);
        return c.creaConsulta(app, getConfigCampos(), tituloCompleto, data);
      }
       ...
       * @author pedrorozo - http://www.smartjsp.com
       */
      public void creaReporte(String tipo, UI app) {
        try {
    ...
    //      }
          ...
          drb.setTitle(getTitulo()) //Titulo
                  ...
                  .setPageSizeAndOrientation(Page.Page_Legal_Landscape()) // tamaño carta apaisado
       ...
       * @param w
       */
      public void creaReporteObjetos(String tipo, UI app) {
        try {
          Style detailStyle = new Style();
          Style headerStyle = new Style();
          Style titleStyle = new Style();
          ...
          for (int i = 0; i < getConfigCampos().size(); i++) // iterativamente crea las columnas
          {
            ...
            Integer tamano = campo.getTamano();
            int multiplier = (COL_ZOOM * COL_MAX) / 2;

            if (tamano == null) {
              tamano = multiplier;
            } else if (tamano < multiplier) {
      ...
      public void exportaReporte() {
        ...
        mimeType = "application/octet-stream";
        csvExporta.setParameter(JRCsvExporterParameter.CHARACTER_ENCODING,"ISO-8859-1");
        ...
        // Ejemplos de paramentros adicionales: más en:
   ...
   */
  public void getStreamWeb(UI app) {
    ...
    StreamResource streamResource = new StreamResource(reporte, archivoSalida);
