...
import com.framework.common.service.security.OpcionModuloService;
import com.framework.common.ui.GenericTab;
import com.framework.common.ui.BienvenidaContent;
...
public class VaadinComponentFactoryImpl implements VaadinComponentFactory {
  ...
  public VaadinComponentFactoryImpl() {
    logger.debug("OPA - " + "Constructor VaadinComponentFactoryImpl");
  ...
  public void initFactory() {
    logger.debug("OPA - " + "initFactory VaadinComponentFactoryImpl");
  ...
  public GenericContent getVaadinComponent(OpcionModulo opcionModulo, GenericTab parentTab) {
    try {
      ...
      throw new FrameworkSistemaException(npe.getMessage(), npe);
    }
